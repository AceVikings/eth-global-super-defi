      ...
      <div className="px-6 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="dialogue-box mb-8">
            ...
            <p className="mb-4">
              "Welcome to the Cross-Chain Swap arena! This is where the magic
              happens - seamless trading across 15+ blockchains powered by 1inch
              Cross-Chain Fusion+ on Starknet!"
            </p>
            <p>
              "Soon you'll be able to swap tokens with optimized routing,
              minimal slippage, and access to unified liquidity pools across the
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="game-card">
              ...
              <p className="text-sm mb-4">
                Trade across 15+ blockchains including Ethereum, Polygon,
            ...
            <div className="game-card">
              ...
              <p className="text-sm mb-4">
                1inch Cross-Chain Fusion+ finds the best routes for minimal
            ...
            <div className="game-card">
              ...
              <p className="text-sm mb-4">
                Access deep liquidity pools across all supported chains for
                better execution.
              </p>
              <div className="nintendo-button opacity-50 cursor-not-allowed">
                Coming Soon
            ...
            <div className="game-card">
              ...
              <p className="text-sm mb-4">
                Leverage Starknet's scalability and cost efficiency for
          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="text-xs mt-2" style={{ color: "var(--charcoal)" }}>
                Integrating with 1inch Cross-Chain Fusion+ and Starknet for
