    ...
    >
      ...
      <section className="relative py-20 px-4 text-center">
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="mb-8">
            <h1
              className="text-6xl md:text-8xl mb-4 animate-pixel-bounce"
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-8">
            ...
            <button className="nintendo-button">HOW TO PLAY</button>
          </div>

          <div className="text-sm" style={{ color: "var(--charcoal)" }}>
            <p>
              🌟 Multi-Chain Support • 💎 Advanced Options • ⚡ Lightning Fast
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            >
              <h3 className="text-lg mb-3" style={{ color: "var(--charcoal)" }}>
                CROSS-CHAIN SWAPS
              </h3>
              <p className="text-sm leading-relaxed">
                Powered by 1inch Cross-Chain Fusion+ on Starknet. Trade
                seamlessly across 15+ blockchains with optimized routing,
                minimal slippage, and unified liquidity access.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-sm leading-relaxed">
                Next-generation derivatives protocol on Citrea. Trade put/call
                options with strategic collateral management and unified Uniswap
                V4 pool integration.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-sm leading-relaxed">
                Perpetual contracts with advanced leverage management and
                cross-collateral optimization for maximum capital efficiency
                while maintaining swap readiness.
              </p>
            </div>
          </div>
        </div>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, var(--light-green) 0%, var(--cream) 100%)",
        }}
      >
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="dialogue-box flex-1">
              ...
              <p className="leading-relaxed">
                "Welcome to the world of decentralized finance! Super DeFi
                combines the excitement of classic gaming with cutting-edge
                blockchain technology. Whether you're a seasoned trader or just
                starting your journey, there's an adventure waiting for
                everyone!"
              </p>
              <div className="mt-4">
