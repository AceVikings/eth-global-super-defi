        ...
        <>
          ...
          <div className="absolute top-full right-0 mt-2 z-50">
            <div className="dialogue-box min-w-80">
              ...
              <div className="mb-6">
                <h4
                  className="text-sm mb-3 font-bold flex items-center gap-2"
                  ...
                  <div className="game-card">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="text-sm font-bold">
                        {formatBalance(evmBalance?.value)}{" "}
                        {evmBalance?.symbol || "ETH"}
                      </div>
                    </div>
                  </div>
                ) : (
                    ...
                    <button
                      onClick={async () => {
                        ...
                        try {
                          ...
                          console.error(
                            "Error connecting Starknet wallet:",
                            error
                          );
                        }
              ...
              <div className="border-t-2 border-charcoal pt-3 mt-4">
                ...
                >
                  ...
                  Optimism, Citrea Testnet, Starknet
                </div>
              </div>
            </div>
          </div>
