        ...
        <>
          ...
          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50">
            <div className="dialogue-box min-w-96 max-w-md">
              <h2 className="text-xl mb-6 text-center" style={{ color: 'var(--warm-red)' }}>
                CONNECT WALLET
              </h2>
              ...
              <div className="flex mb-6 border-2 border-charcoal rounded-lg overflow-hidden">
                <button
                  ...
                  style={{
                    backgroundColor: activeTab === 'evm' ? 'var(--sky-blue)' : 'var(--light-gray)',
                    color: activeTab === 'evm' ? 'var(--white)' : 'var(--charcoal)'
                  }}
                >
                  EVM CHAINS
                </button>
                <button
                  ...
                  style={{
                    backgroundColor: activeTab === 'starknet' ? 'var(--soft-purple)' : 'var(--light-gray)',
                    color: activeTab === 'starknet' ? 'var(--white)' : 'var(--charcoal)'
                  }}
                >
                  STARKNET
                </button>
              ...
              <div className="mb-6">
                {activeTab === 'evm' ? (
                  <div>
                    <p className="text-sm mb-4 text-center" style={{ color: 'var(--charcoal)' }}>
