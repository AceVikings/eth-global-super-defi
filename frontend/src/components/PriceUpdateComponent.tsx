...
export const PriceUpdateComponent: React.FC<PriceUpdateComponentProps> = ({
  className = "",
}) => {
  ...
  const updatePrice = async (asset: "BTC" | "ETH", price: string) => {
    ...
    try {
      ...
      const contractAddress =
        asset === "BTC"
          ? CONTRACT_ADDRESSES.BTC_PRICE_FEED
          : CONTRACT_ADDRESSES.ETH_PRICE_FEED;
  ...
  return (
    <div className={className}>
      <div className="terminal-panel">
        <div className="mb-6">
          <h3
            className="text-lg font-mono font-bold mb-2 uppercase tracking-wider"
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 terminal-window p-4 mb-6">
            <div className="text-center">
              ...
              >
                $
                {currentBtcPrice
                  ? Number(currentBtcPrice).toLocaleString()
                  : "..."}
              </div>
            </div>
            <div className="text-center">
              ...
              >
                $
                {currentEthPrice
                  ? Number(currentEthPrice).toLocaleString()
                  : "..."}
              </div>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <div
                  className="text-sm font-mono mb-2 uppercase"
                  style={{ color: "var(--retro-green)" }}
                >
                  BTC SCENARIOS
                </div>
